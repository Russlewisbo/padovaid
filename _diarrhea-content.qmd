...
![Mechanisms of bacterial diarrheal disease showing secretory and invasive pathways.](images-diarrhea-webpage/ch100-003.png){#fig-bacterial-mechanisms width="90%"}
...
![Campylobacter jejuni microscopy and culture morphology.](images-diarrhea-webpage/ch100-009.png){#fig-campylobacter width="80%"}
...
| Category | Clinical Feature | Approximate Frequency ^a^ |
|----|----|----|
...
: Clinical Features of Typhoid and Paratyphoid Fever {#tbl-cholera-features}

^a^ The proportion of patients demonstrating these clinical features varies depending on the time, region, and clinical population (hospitalized or ambulatory) assessed. Estimates are drawn from recent case series in endemic areas, with patients presenting for ambulatory or inpatient care.

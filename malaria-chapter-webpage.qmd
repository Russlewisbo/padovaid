...
![The *Plasmodium* life cycle. Anopheline mosquitoes transmit malaria by injecting sporozoites into the human host. Sporozoites invade hepatocytes, developing into schizonts that release merozoites into the bloodstream. Some *P. vivax* and *P. ovale* parasites persist as hypnozoites in the liver, causing relapses months to years later. The asexual blood cycle repeats every 24 h (*P. knowlesi*), 48 h (*P. falciparum*, *P. vivax*, *P. ovale*), or 72 h (*P. malariae*). A minority of parasites develop into sexual-stage gametocytes, which are taken up by feeding mosquitoes to complete the transmission cycle. (Created in BioRender. Jillian Armstrong and Sunil Parikh, 2024.)](images_malaria/fig280-1_life_cycle.png){#fig-lifecycle fig-alt="Plasmodium life cycle diagram showing mosquito and human stages"}
...
![Map of the global prevalence and distribution of *Plasmodium falciparum* and *Plasmodium vivax* in 2022. (A) *P. falciparum* parasite rate (PfPR), age-standardised for children 2–10 years. (B) *P. vivax* parasite rate (PvPR), all-age. Data from Weiss DJ et al., *Lancet*, 2025. ©2025 Malaria Atlas Project.](images_malaria/fig280-2_world_map.png){#fig-worldmap fig-alt="World maps showing global distribution of P. falciparum and P. vivax malaria in 2022"}

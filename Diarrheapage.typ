...
= 
<section>
#link("https://russlewisbo.github.io/diarrhea/diarrhea-slides.html#/title-slide#/title-slide")[HTML Slides]

#link("enteric.pdf")[PDF slide]

#link("ACG.pdf")[ACG Clinical Guideline: Diagnosis, Treatment, and Prevention of Acute Diarrheal Infections in Adults]

#link("IDSAdiarrhae.pdf")[2017 Infectious Diseases Society of America Clinical Practice Guidelines for the Diagnosis and Management of Infectious Diarrhea]

A useful review that contains information on when and what tests to use for symptomatic diarrhea #link("Syndromic.pdf")[Syndromic Panel-Based Testing in Clinical Microbiology]

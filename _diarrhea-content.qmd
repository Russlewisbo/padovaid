...
![Norovirus electron micrograph and genetic classification of caliciviruses.](images-diarrhea-webpage/ch100-002.png){#fig-norovirus width="80%"}
...
![Cryptosporidium life cycle and oocyst morphology in acid-fast staining.](images-diarrhea-webpage/ch100-005.png){#fig-cryptosporidium width="80%"}
...
![Methylene blue stain of fecal leukocytes — a bedside marker of inflammatory (invasive) diarrhea.](images-diarrhea-webpage/ch100-007.png){#fig-fecal-leukocytes width="70%"}
...
#### Shiga Toxin–Producing *E. coli* (STEC) and HUS
...
| Pathotype | Common O Serogroups |
|-------------------------|-----------------------------------------------|
| **EIEC** (enteroinvasive *E. coli*) | O28ac, O29, O112, O115, O124, O135, O136, O143, O144, O152, O159, O164, O167, O173 |
| **EPEC** (enteropathogenic *E. coli*) | O55, O86, O111, O114, O119, O125, O126, O127, O128, O142 |
| **ETEC** (enterotoxigenic *E. coli*) | O6, O8, O15, O20, O25, O27, O63, O78, O80, O85, O115, O128ac, O139, O148, O153, O159, O167 |
| **STEC/EHEC** (Shiga toxin–producing) | O157:H7 (most common in Northern Europe and U.S.), also O26, O103, O111, O121, O145 |

: O Serogroups Associated with Diarrheagenic *E. coli* Pathotypes
...
![Global distribution of typhoid and paratyphoid fever, with highest incidence concentrated in South and Southeast Asia and parts of sub-Saharan Africa.](images-diarrhea-webpage/ch100-009.png){#fig-typhoid-distribution width="80%"}
...
### Geographic Variation in Pathogen Frequency

The relative frequency of specific pathogens in traveler's diarrhea differs substantially by destination region, reflecting local epidemiology, climate, and food/water hygiene practices.

| Pathogen | Latin America | Africa | South / Southeast Asia |
|----|----|----|----|
| **ETEC** | 33% | 31% | 31% |
| **EAEC** | 19% | 16% | 7% |
| ***Campylobacter*** | 1% | 2% | 32% |
| ***Salmonella*** | 4% | 5% | 7% |
| ***Shigella*** | 5% | 9% | 4% |
| ***Aeromonas* / *Plesiomonas*** | 2% | 1% | 4% |
| **Norovirus** | 17% | — | 12% |
| **Rotavirus** | 6% | — | 8% |
| ***Giardia*** | 2% | 3% | 1% |
| ***Cryptosporidium*** | 2% | 2% | 2% |
| ***Entamoeba histolytica*** | <1% | <1% | 2% |
| **No pathogen identified** | 24% | 33% | 21% |

: Approximate Frequency of Pathogens Identified in Traveler's Diarrhea by Destination Region {#tbl-td-locale}
...
#### Pathogen Frequencies in AIDS — With and Without Diarrhea

A key concept from epidemiologic studies of enteric infection in HIV is that detection of a potential pathogen in stool does not necessarily prove causation; many of these organisms can also be recovered from asymptomatic AIDS patients. The table below summarizes typical detection frequencies in AIDS cohorts with and without diarrhea.

| Pathogen | AIDS with Diarrhea (%) | AIDS without Diarrhea (%) |
|----|----|----|
| ***Cryptosporidium*** | 15–25 | 1–5 |
| **Microsporidia** (*E. bieneusi*) | 15–30 | 1–10 |
| ***Cytomegalovirus*** | 10–20 | 1–5 |
| ***Mycobacterium avium* complex** | 10–15 | <5 |
| ***Isospora belli*** | 1–5 | <1 |
| ***Giardia lamblia*** | 2–5 | 2–5 |
| ***Entamoeba histolytica*** | 1–3 | 1–3 |
| ***Clostridioides difficile*** | 5–15 | 2–5 |
| ***Salmonella*** / ***Shigella*** / ***Campylobacter*** | 2–8 | <2 |
| **No pathogen identified** | 20–40 | — |

: Possible Enteric Pathogens in AIDS Patients (Approximate Detection Frequencies) {#tbl-aids-pathogens}

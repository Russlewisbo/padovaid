...
![Norovirus electron micrograph and genetic classification of caliciviruses.](images3/norovirus.jpeg){#fig-norovirus width="80%"}
...
![Cryptosporidium life cycle and oocyst morphology in acid-fast staining.](images3/giardia.png){#fig-cryptosporidium width="80%"}
...
![Mechanisms of bacterial diarrheal disease showing secretory and invasive pathways.](images3/ecoli.png){#fig-bacterial-mechanisms width="90%"}
...
![Shiga toxin-producing E. coli (STEC) and hemolytic uremic syndrome pathophysiology.](images3/schistocytes.png){#fig-stec-hus width="80%"}
...
![Campylobacter jejuni microscopy and culture morphology.](images3/campystool.png){#fig-campylobacter width="80%"}
...
![Vibrio cholerae electron micrograph and cholera toxin mechanism of action.](images3/vibrio.png){#fig-cholera width="80%"}

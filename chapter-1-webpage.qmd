...
<!-- IMAGE NEEDED: Schema of posterior peritoneal reflections and anatomic recesses (FIG. 76.1) -->

<!-- IMAGE NEEDED: Sagittal section showing peritoneal spaces in upper abdomen (FIG. 76.2) -->
...
<!-- IMAGE NEEDED: CT scan showing intraperitoneal abscess with drainage catheter (FIG. 76.3) -->

<!-- IMAGE NEEDED: CT showing liver abscesses with percutaneous drains (FIG. 76.4) -->

<!-- IMAGE NEEDED: CT showing percutaneous drainage of intraperitoneal abscess (FIG. 76.5) -->

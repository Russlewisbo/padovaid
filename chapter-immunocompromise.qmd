...
![The vein-to-vein CAR-T cell therapy process. The patient's T cells are collected, genetically engineered with a viral vector to express a chimeric antigen receptor (CAR), expanded ex vivo, and then reinfused to identify and kill cancer cells bearing the target antigen.](images-immunocompromise/Chimeric%20Antigen%20Receptor%20(CAR)%20T%20Cell%20Therapy_%20Vein-to-Vein%20Process.png){#fig-cart-process fig-align="center"}

![Mechanism of graft-versus-host disease (GVHD) after allogeneic hematopoietic stem cell transplantation. Host conditioning releases DAMPs and cytokines that activate donor T cells via host antigen-presenting cells. Activated donor T cells attack host tissues (causing GVHD in skin, gut, liver, and the haematopoietic system) while also exerting a beneficial graft-versus-tumour (GVT) effect.](images-immunocompromise/allo_hcst.png){#fig-hsct-gvhd fig-align="center"}

![Timeline of immunosuppression and infectious complications associated with CAR-T cell therapy. The lymphodepletion conditioning regimen, cytokine release syndrome (CRS), immune effector cell-associated neurotoxicity syndrome (ICANS), and prolonged B-cell aplasia each create distinct windows of infection vulnerability [@maus2020].](images-immunocompromise/car-t.png){#fig-cart-timeline fig-align="center"}
...
![Workflow of the ImmuKnow assay. Whole blood is stimulated with phytohemagglutinin (PHA) to activate lymphocytes; CD4+ T cells are then isolated by magnetic separation. After cell lysis, released intracellular ATP is quantified by bioluminescence. Higher ATP levels indicate greater CD4+ T-cell function and lower net immunosuppression.](images-immunocompromise/immunoknow.png){#fig-immunoknow fig-align="center"}
...
![Mechanism of ibrutinib-associated invasive aspergillosis. Left: the RESONATE-2 trial demonstrating superior progression-free survival of ibrutinib over chlorambucil in CLL. Right: BTK inhibition impairs not only B-cell receptor signaling but also antifungal effector immunity (neutrophil and macrophage function), particularly when combined with concurrent glucocorticoid therapy.](images-immunocompromise/ibrutinib.png){#fig-ibrutinib fig-align="center"}

![Central nervous system aspergillosis complicating ibrutinib therapy. A French surveillance study (FILO) identified 33 cases of aspergillosis in ibrutinib-treated CLL patients; CNS involvement was present in 40% of cases, typically within 3 months of starting therapy. T2-weighted FLAIR MRI reveals multiple cerebral abscesses.](images-immunocompromise/cns_aspergillosis.png){#fig-cns-asp fig-align="center"}

...
date: last-modified
bibliography: refs-febrile-neutropenia.bib
...
![Normal hematopoiesis showing myeloid and lymphoid lineages](images-febrile-neutropenia/hematopoesis.png){#fig-hematopoiesis}
...
![Effects of corticosteroids on immune function](images-febrile-neutropenia/corticosteroids.png){#fig-corticosteroids}
...
![Relationship between neutrophil count and infection risk, from the landmark Bodey et al. study](images-febrile-neutropenia/bodey.png){#fig-bodey}
...
![Hypervirulent multidrug-resistant *Pseudomonas aeruginosa* infection in a neutropenic patient [@Coppola20201]](images-febrile-neutropenia/MDR%20pseudomonas.png){#fig-mdr-pseudomonas}
...
![Chemotherapy-associated dysbiosis of the gastrointestinal microbiome](images-febrile-neutropenia/dysbiosis.png){#fig-dysbiosis}

![Model of mucosal barrier injury during anti-cancer treatment [@basile2019]](images-febrile-neutropenia/mucosalbarrier%20injury.png){#fig-mbi}

![WHO oral toxicity scale for grading mucositis severity](images-febrile-neutropenia/mucositis.png){#fig-mucositis}
...
![Gastrointestinal sources of translocating pathogens](images-febrile-neutropenia/GI%20sourse.png){#fig-gi-source}
...
![Etiology of bloodstream infections in cancer patients](images-febrile-neutropenia/pathogens.png){#fig-pathogens}
...
![Typical sequence of infections during neutropenia](images-febrile-neutropenia/sequence.png){#fig-sequence}
...
![Relationship between duration of granulocytopenia and risk of invasive pulmonary aspergillosis](images-febrile-neutropenia/gerson.png){#fig-gerson}
...
![Pathogens associated with impaired cell-mediated immunity](images-febrile-neutropenia/cmi_pathogens.png){#fig-cmi-pathogens}
...
![Clinical and radiographic features of mucormycosis](images-febrile-neutropenia/mucor.png){#fig-mucormycosis}
...
::: {layout-ncol=2}
![Biofilm formation cycle on central venous catheters](images-febrile-neutropenia/Biofilm%20Formation%20Cycle.png){#fig-biofilm-cycle}

![*Staphylococcus aureus* biofilm on catheter surface](images-febrile-neutropenia/Staphylococcus_aureus_biofilm_01.jpg){#fig-staph-biofilm}
:::
...
![Skin lesions as evidence of disseminated infection in neutropenic patients](images-febrile-neutropenia/skin.png){#fig-skin-lesions}
...
![Oral infections in neutropenic patients: Candida and HSV](images-febrile-neutropenia/oral.png){#fig-oral-infections}
...
::: {layout-ncol=2}
![Normal chest X-ray in a neutropenic patient with occult pneumonia](images-febrile-neutropenia/clipboard-4243987732.png){#fig-normal-cxr}

![CT scan revealing pulmonary infiltrates not visible on chest X-ray](images-febrile-neutropenia/CT%20image.png){#fig-ct-pneumonia}
:::

#### Common CT Findings in Neutropenic Pneumonia

![CT imaging patterns and their differential diagnosis in neutropenic patients](images-febrile-neutropenia/ct_imaging.png){#fig-ct-patterns width="100%"}
...
![Role of bronchoscopy and BAL in the diagnosis of pulmonary infections in neutropenic patients](images-febrile-neutropenia/BAL.png){#fig-bronchoscopy}

### Neutropenic Enterocolitis (Typhlitis)

![CT findings in neutropenic enterocolitis showing bowel wall thickening](images-febrile-neutropenia/typhlitis.png){#fig-typhlitis}

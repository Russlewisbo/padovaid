...
title-slide-attributes:
  data-background-image: /images-fuo/bacteria.png
format:
  revealjs:
    touch: true
    controls: true
...
## Fever of unknown origin (FUO) {background-image="/images-fuo/bacteria.png"}
...
## The history of fever {background-image="/images-fuo/hippocrates.jpg" background-opacity="0.2" data-background-size="contain"}
...
![](images-fuo/Febris.png){fig-align="center" width="600"}
...
::::: columns
::: {.column width="50%"}
![](images-fuo/Galileo.png){width="600"}
:::
...
![](images-fuo/Galileo%20thermometer.png){fig-align="center" width="600"}
:::
:::::
...
![](images-fuo/Wunderlich.png){fig-align="center" width="600"}
...
![](images-fuo/thermoregulation.png){fig-align="center" width="800"}
...
![](images-fuo/LPSfever.png){fig-align="center" width="600"}
...
![](images-fuo/acutephase1.png){fig-align="center"}
...
![](images-immunocompromise-slides/Acute-Phase%20Proteins.png){fig-align="center" width="600"}

## Acute phase phenomena

![](images-fuo/acutephase.png){fig-align="center" width="600"}
...
![](images-fuo/FUOdef.png){fig-align="center" width="700"}
...
![](images-fuo/FUOcat.png){fig-align="center" width="600"}
...
![](images-fuo/misc.jpeg){fig-align="center"}
...
![](images-fuo/traveler.png){fig-align="center"}
...
- Neutropenia is defined as an ANC of \< 500 cells/mm^3^ or an ANC that is expected to decrease to \< 500 cells/mm^3^ during the next 48 h.
...
![](images-fuo/fuo_neutro.png){fig-align="center"}
...
![](images-fuo/CMI_Th1.png){fig-align="center"}
...
![](images-fuo/CMI_Th2.png){fig-align="center"}
...
![](images-fuo/CMI_allergy.png){fig-align="center"}
...
![](images-fuo/immunocomp.png){fig-align="center"}
...
![](images-fuo/FUO_HIV.png){fig-align="center" width="500"}
...
## Diagnosis of FUO {background-image="/images-fuo/thermometer.jpg"}
...
![](images-fuo/continuous.png){fig-align="center" width="500"}
...
![](images-fuo/malariafever.png){fig-align="center"}
...
![](images-fuo/saddle.png){fig-align="center" width="500"}
...
![](images-fuo/pelebstein.png){fig-align="center" width="500"}
...
![](images-fuo/clinicalsigns.jpeg){fig-align="center"}
...
![](images-fuo/diagnosticcludes.jpeg){fig-align="center"}
...
- Generally low diagnostic yield without localizing symptoms
  ...
  - Gallium-67 (^67^Ga) scan (replaced by PET-CT)

## ^18^F-fluorodeoxyglucose (FDG) positron emission tomography (PET)

<br>

![](images-fuo/pet1.png){fig-align="center"}
...
![](images-fuo/pet2.png){fig-align="center"}
...
## Treatment {background-image="/images-fuo/thermometer.jpg" background-opacity="0.2"}

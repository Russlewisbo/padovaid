...
| [Malaria](malaria.qmd) | Epidemiology, diagnosis, and treatment of malaria |
...
| Guide | Description |
|------------------------------------|------------------------------------|
| [Study Guide (English)](study-guide.qmd) | Key concepts from all lectures — [📄 PDF](study-guide.pdf){target="_blank"} |
| [Guida allo Studio (Italiano)](guida-studio.qmd) | Principi antibiotici, allergie, ospite immunocompromesso, neutropenia febbrile, infezioni fungine invasive — [📄 PDF](guida-studio.pdf){target="_blank"} |

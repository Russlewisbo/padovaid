...
![Normal hematopoiesis showing myeloid and lymphoid lineages](images-febrileneutropenia/hematopoesis.png){#fig-hematopoiesis}
...
![Effects of corticosteroids on immune function](images-febrileneutropenia/corticosteroids.png){#fig-corticosteroids}
...
![Relationship between neutrophil count and infection risk, from the landmark Bodey et al. study](images-febrileneutropenia/bodey.png){#fig-bodey}
...
![Hypervirulent multidrug-resistant *Pseudomonas aeruginosa* infection in a neutropenic patient [@Coppola20201]](images-febrileneutropenia/MDR%20pseudomonas.png){#fig-mdr-pseudomonas}
...
![Chemotherapy-associated dysbiosis of the gastrointestinal microbiome](images-febrileneutropenia/dysbiosis.png){#fig-dysbiosis}

![Model of mucosal barrier injury during anti-cancer treatment [@basile2019]](images-febrileneutropenia/mucosalbarrier%20injury.png){#fig-mbi}

![WHO oral toxicity scale for grading mucositis severity](images-febrileneutropenia/mucositis.png){#fig-mucositis}
...
![Gastrointestinal sources of translocating pathogens](images-febrileneutropenia/GI%20sourse.png){#fig-gi-source}
...
![Etiology of bloodstream infections in cancer patients](images-febrileneutropenia/pathogens.png){#fig-pathogens}
...
![Typical sequence of infections during neutropenia](images-febrileneutropenia/sequence.png){#fig-sequence}
...
![Relationship between duration of granulocytopenia and risk of invasive pulmonary aspergillosis](images-febrileneutropenia/gerson.png){#fig-gerson}
...
![Pathogens associated with impaired cell-mediated immunity](images-febrileneutropenia/cmi_pathogens.png){#fig-cmi-pathogens}
...
![Clinical and radiographic features of mucormycosis](images-febrileneutropenia/mucor.png){#fig-mucormycosis}
...
::: {layout-ncol=2}
![Biofilm formation cycle on central venous catheters](images-febrileneutropenia/Biofilm%20Formation%20Cycle.png){#fig-biofilm-cycle}

![*Staphylococcus aureus* biofilm on catheter surface](images-febrileneutropenia/Staphylococcus_aureus_biofilm_01.jpg){#fig-staph-biofilm}
:::
...
![Skin lesions as evidence of disseminated infection in neutropenic patients](images-febrileneutropenia/skin.png){#fig-skin-lesions}
...
![Oral infections in neutropenic patients: Candida and HSV](images-febrileneutropenia/oral.png){#fig-oral-infections}
...
::: {layout-ncol=2}
![Normal chest X-ray in a neutropenic patient with occult pneumonia](images-febrileneutropenia/clipboard-4243987732.png){#fig-normal-cxr}

![CT scan revealing pulmonary infiltrates not visible on chest X-ray](images-febrileneutropenia/CT%20image.png){#fig-ct-pneumonia}
:::

#### Common CT Findings in Neutropenic Pneumonia

![CT imaging patterns and their differential diagnosis in neutropenic patients](images-febrileneutropenia/ct_imaging.png){#fig-ct-patterns width="100%"}
...
![Role of bronchoscopy and BAL in the diagnosis of pulmonary infections in neutropenic patients](images-febrileneutropenia/BAL.png){#fig-bronchoscopy}

### Neutropenic Enterocolitis (Typhlitis)

![CT findings in neutropenic enterocolitis showing bowel wall thickening](images-febrileneutropenia/typhlitis.png){#fig-typhlitis}

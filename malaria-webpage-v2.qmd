...
![Map of the global prevalence and distribution of *Plasmodium falciparum* and *Plasmodium vivax* in 2022. (A) *P. falciparum* parasite rate (PfPR), age-standardised for children 2–10 years. (B) *P. vivax* parasite rate (PvPR), all-age. Data from Weiss DJ et al., *Lancet*, 2025. ©2025 Malaria Atlas Project.](images-malaria/fig280-2_world_map.png){#fig-worldmap fig-alt="World maps showing global distribution of P. falciparum and P. vivax malaria in 2022"}
...
![Sequestration of parasitized erythrocytes in the microvasculature of the brain and the ocular fundus. (A–D) Representative histologic (H&E; A, C) and cytologic (Giemsa; B, D) images from a cerebral malaria autopsy showing trophozoites and schizonts. (E–H) Ocular fundus photography and fluorescein angiography from children with cerebral malaria showing hemorrhages, retinal whitening, and vascular occlusion/nonperfusion. (From Milner DA Jr et al., *J Infect Dis* 2012; and Beare NAV et al., *J Infect Dis* 2009.)](images-malaria/fig280-4_cerebral_malaria.png){#fig-sequestration fig-alt="Cerebral malaria sequestration histology and retinal angiography"}
...
: Severe malaria criteria: one or more of the following, in the absence of an identified alternative cause and in the presence of asexual malaria parasitemia. Adapted from WHO Guidelines for Malaria, October 2023 [@WHO2023Guidelines].
...
: Key light microscopy features for speciation of human malaria parasites.
...
: Recommended treatment regimens for uncomplicated malaria. Artesunate component across all ACTs is uniformly dosed at 4 mg/kg/day for 3 days. All ACTs achieve PCR-adjusted cure rates \>95% in areas without partner-drug resistance [@CDC2023MalariaTreatment; @WHO2023Guidelines].

...
![Map of the global prevalence and distribution of *Plasmodium falciparum* and *Plasmodium vivax* in 2022. (A) *P. falciparum* parasite rate (PfPR), age-standardised for children 2–10 years. (B) *P. vivax* parasite rate (PvPR), all-age. Data from Weiss DJ et al., *Lancet*, 2025. ©2025 Malaria Atlas Project.](images-fuo/fig280-2.png){#fig-worldmap fig-alt="World maps showing global distribution of P. falciparum and P. vivax malaria in 2022"}
...
![Sequestration of parasitized erythrocytes in the microvasculature of the brain and the ocular fundus. (A–D) Representative histologic (H&E; A, C) and cytologic (Giemsa; B, D) images from a cerebral malaria autopsy showing trophozoites and schizonts. (E–H) Ocular fundus photography and fluorescein angiography from children with cerebral malaria showing hemorrhages, retinal whitening, and vascular occlusion/nonperfusion. (From Milner DA Jr et al., *J Infect Dis* 2012; and Beare NAV et al., *J Infect Dis* 2009.)](images-fuo/fig280-4.png){#fig-sequestration fig-alt="Cerebral malaria sequestration histology and retinal angiography"}
